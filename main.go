		...
		Attachments: []Attachment{
			{
				...
				Footer:     envOr(EnvSlackFooter, "<https://github.com/"+os.Getenv("GITHUB_REPOSITORY")+"|"+os.Getenv("GITHUB_REPOSITORY")+">"),
				FooterIcon: "https://github.githubassets.com/favicon.ico",
				Fields:     fields,
			},
		},
	}
